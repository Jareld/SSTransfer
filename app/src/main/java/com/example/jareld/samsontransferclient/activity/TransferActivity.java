        ...
        implements View.OnClickListener
{
    ...
    private static final String TAG                      = "Jareld_ClientActivity";
    ...
    private boolean mFirst_enter = true;
...
//                    Toast.makeText(getApplicationContext(), "连接失败，请重新搜索设备并且连接", Toast.LENGTH_LONG)
//                         .show();
                    Toast.makeText(getApplicationContext(), "Connect Fail，Please re-discovered and connect device", Toast.LENGTH_LONG)
                         .show();
                    break;
                default:
                    break;
    ...
    private void createConnet(String name, final String address) {
        ...
        //中文  连接设备   连接中 :
        connectingProgressDialog = ProgressDialog.show(this, "Connect Deivces", "Connecting :" + address, true, true,
                                                       // cancellable
        ...
        mHandler.sendEmptyMessageDelayed(DISCONNECT, 20000);
...
//                         .show();
            ...
            case R.id.connect_device:
                ...
                if (mPeerLists != null && mPeerLists.size() != 0 && !mFirst_enter) {
